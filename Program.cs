...
namespace JogoDaVelha
{
    class Program
    {
        ...
        {
            System.Console.WriteLine("Jogador " + jogadorAtual + ", faça sua jogada.");
            System.Console.WriteLine("Digite a linha: ");
            int linha = Convert.ToInt32(Console.ReadLine());
            System.Console.WriteLine("Digite a coluna: ");
            int coluna = Convert.ToInt32(Console.ReadLine());

            if(tabuleiro[linha, coluna] == '-') {
                tabuleiro[linha, coluna] = jogadorAtual;
            }else{
                System.Console.WriteLine("Essa posição já está ocupada. Tente novamente");
                FazerJogada();
            }
        }
        ...
        static void VerificarFimDeJogo()
        {
            if(VerificarVencedor()){
                ExibirTabuleiro();
                System.Console.WriteLine("Jogador "+jogadorAtual+"venceu!");;
                jogoAcabou = true;
